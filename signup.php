...
if(isset($_POST['submit'])){
	...
	if(!empty($name) || !empty($email) || !empty($regNo) || !empty($contact) || !empty($gender) || !empty($password)){
		$sql="INSERT INTO student_signup(name,email,regNo,contact,gender,password) VALUES('$name','$email','$regNo','$contact','$gender','$password')";
